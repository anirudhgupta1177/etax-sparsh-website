...
1. [Brand Overview & Story](#1-brand-overview--story)
2. [Name & Meaning](#2-name--meaning)
3. [Positioning & Value Proposition](#3-positioning--value-proposition)
4. [Tagline & Messaging Pillars](#4-tagline--messaging-pillars)
5. [Logo](#5-logo)
6. [Colour Palette](#6-colour-palette)
7. [Typography](#7-typography)
8. [Iconography & Imagery](#8-iconography--imagery)
9. [UI Tokens](#9-ui-tokens)
10. [Voice & Tone](#10-voice--tone)
11. [Accessibility](#11-accessibility)
12. [Legal & Usage Note](#12-legal--usage-note)
...
A modern, trustworthy, expert-led tax brand that feels less like a government form and more like having a competent CA in your pocket.
...
| --- | --- |
| Full brand name (running text) | eTax Profilling |
| Wordmark / logo lockup | **eTax** in ink/dark, **Profilling** in brand blue (`#1B4DFF`) |
| First word casing | Lowercase **e**, capital **T** → "eTax" (never "ETax", "Etax", or "E-Tax") |
| Second word casing | Capital **P** → "Profilling" (note the double **l**) |
| Sentence start | Even at the start of a sentence, keep the lowercase "e": *"eTax Profilling files…"* |
| Spoken / phonetic | "ee-tax pro-filling" |
...
**Category:** Online income-tax and GST filing + tax planning for Indian taxpayers.
...
- **Expert + AI, not either/or.** Smart tools pre-fill and pre-check; a Chartered Accountant reviews and signs off. You get speed *and* a human safety net.
- **Maximised, lawful refunds.** We surface deductions and regime choices (old vs. new) that DIY filers routinely miss.
- **Transparent, fixed pricing.** The price you see is the price you pay. No upsell traps, no "convenience" surprises.
- **End-to-end coverage.** ITR filing, GST returns, notice and rectification handling, advance-tax and capital-gains planning, bookkeeping for small businesses.
- **Compliant and secure.** Your data is handled carefully, and your filing meets statutory requirements.

### Who we serve

Salaried individuals · Freelancers & consultants · NRIs · Capital-market & crypto investors · Small businesses & professionals · Startups needing GST and bookkeeping.

---

## 4. Tagline & Messaging Pillars

### Primary tagline

> **Professional Tax Filing, Simplified.**

Use this as the default tagline under the wordmark and in hero sections. Keep the capitalisation and the full stop.

### Messaging pillars

Every piece of communication should ladder up to one of these five pillars. Lead with the pillar most relevant to the audience and moment.
...
| **Speed** | Smart tools remove the busywork; filing in days, not weeks. | "Most returns filed within a few working days." · "Less paperwork. Faster filing." |
...
| File | Use |
| --- | --- |
| `assets/img/logo.svg` | **Full-colour** primary logo. Use on white and light backgrounds. |
| `assets/img/logo-white.svg` | **White / reversed** logo. Use on the ink/navy gradient and dark photography. |
| `assets/img/logo-mark.svg` | **Mark only** (icon, no wordmark). Use for favicons, app icons, avatars, and tight spaces. |
| `assets/img/favicon.svg` | Browser **favicon** (square, mark-based, optimised for 16–32 px). |
...
Maintain clear space around the logo equal to the **height of the lowercase "e"** in the wordmark (the cap-height of the mark for the mark-only version) on all four sides. No text, image, or graphic element may intrude into this zone.
...
| Token | Hex | Usage |
| --- | --- | --- |
| **Primary** | `#1B4DFF` | Primary brand blue. Wordmark "Profilling", primary buttons, links, key accents. |
| **Primary 700** | `#0B36C9` | Darker blue. Hover/pressed states, gradients, emphasis on light backgrounds. |
| **Primary 50** | `#EEF3FF` | Lightest blue tint. Subtle section backgrounds, badges, selected states. |
| **Accent Mint** | `#12C58B` | Success, "savings/refund" highlights, gradient terminus, positive indicators. |
| **Accent 700** | `#0A8F63` | Darker mint. Mint text on light backgrounds, hover for accent buttons. |
| **Gold** | `#FFB020` | Ratings, premium/"featured" tags, sparing celebratory highlights. |
| **Ink** | `#0A1633` | Primary text, headings, dark surfaces, wordmark "eTax". |
| **Ink-2** | `#41506E` | Secondary text, body copy on light backgrounds, sub-headings. |
| **Ink-3** | `#6B7A99` | Tertiary text, captions, placeholders, muted labels. |
| **Line** | `#E6ECF5` | Borders, dividers, card outlines, input strokes. |
| **BG Soft** | `#F4F7FF` | Soft section background to separate bands from pure white. |
| **White** | `#FFFFFF` | Default page background, card surfaces, reversed text. |

### Gradients

| Gradient | Definition | Usage |
| --- | --- | --- |
| **Brand** | `linear-gradient(120deg, #1B4DFF 0%, #2E6BFF 50%, #12C58B 100%)` | Hero accents, the logo mark, gradient text, primary CTA fills, decorative shapes. |
| **Ink** | `linear-gradient(180deg, #0A1633 0%, #122252 55%, #0B1A3D 100%)` | Dark CTA bands, footer, dark media frames, reversed-logo backgrounds. |

> The brand gradient should flow **blue → mint** and is the signature visual cue. Keep mint as the *terminus*, never the dominant colour.
...
| --- | --- | --- | --- |
| **Headings & wordmark** | **Plus Jakarta Sans** | 700 (Bold), 800 (ExtraBold) | Geometric, confident, modern. Tight tracking on display sizes. |
| **Body, UI & labels** | **Inter** | 400 (Regular), 500 (Medium), 600 (SemiBold) | Highly legible at small sizes; the workhorse for paragraphs, forms, and captions. |

Both are loaded from Google Fonts. A system fallback stack is provided for resilience:
...
| --- | --- | --- | --- | --- |
| Display / H1 | 48–64 px | 1.05–1.1 | Jakarta 800 | Hero headlines |
| H2 | 34–40 px | 1.15 | Jakarta 700/800 | Section heads |
| H3 | 24–28 px | 1.25 | Jakarta 700 | Card titles, sub-sections |
| H4 | 18–20 px | 1.3 | Jakarta 700 | Step / feature titles |
| Lead | 18–20 px | 1.6 | Inter 400/500 | Intro paragraphs |
| Body | 16 px | 1.65 | Inter 400 | Default paragraph text |
| Small / caption | 13–14 px | 1.5 | Inter 400/500 | Captions, helper text, labels |
| Eyebrow | 12–13 px | 1.4 | Inter 600, +0.08em, uppercase | Section kickers |

Scale down ~15–20% on mobile; never let body copy drop below **15 px**.

### Usage rules

- **Headings:** Plus Jakarta Sans only. Keep colour to Ink (or white on dark). Use `gradient-text` sparingly for one key phrase per view.
- **Body:** Inter, Ink-2 for paragraphs, Ink-3 for captions. Avoid Jakarta for long-form reading.
- **Measure:** keep body line length to ~60–75 characters (`max-width` ≈ 640–720 px).
- **Emphasis:** use weight (500/600), not italics, for emphasis in UI.
- Never mix more than the two brand typefaces. No condensed, script, or decorative faces.
...
- ❌ No cheesy "handshake / man-in-suit / pointing-at-graph" stock clichés.
- ❌ No piles of cash, gold coins, or "₹ raining" visuals.
- ❌ No fake government seals, Ashoka emblems, or anything resembling official IT-Department branding.
- ❌ No low-resolution screenshots of the actual e-filing portal.
...
| Token | Value | Use |
| --- | --- | --- |
| `--r-sm` | 8 px | Inputs, small chips, tags |
| `--r-md` | 12 px | Buttons, small cards |
| `--r-lg` | 16 px | Cards, media frames |
| `--r-xl` | 24 px | Large panels, hero cards, sections |
| `--r-pill` | 999 px | Pills, toggles, avatar circles |
...
| `--sh-brand` | Coloured blue glow for primary CTAs and hero accents |

Shadows are **soft and blue-tinted**, never harsh black. Elevation should feel like daylight, not a spotlight.

### Spacing rhythm

Use a **4 px base unit**; prefer multiples of 8 for layout. Common steps: **4, 8, 12, 16, 24, 32, 48, 64, 96 px**.

- Inside components: 8 / 12 / 16 px.
- Between components: 24 / 32 px.
- Section padding (vertical): 64–96 px desktop, 48–64 px mobile.
- Container max-width: ~1200 px, gutters 24 px.
...
| Do | Don't |
| --- | --- |
| "We'll file your return, reviewed by a CA." | "We guarantee the biggest refund in India." |
| "Examples of refunds we've helped recover." | "You will save ₹50,000." |
| "Transparent, fixed pricing." | "Lowest price, no questions asked!!!" |
| "Independent tax-filing service." | "Official income-tax e-filing partner." |
| "Most returns filed within a few working days." | "Instant filing in 60 seconds!" |
| "Let's choose the right tax regime for you." | "Old regime is always better." |

Avoid exclamation pile-ups, ALL-CAPS shouting, fear-mongering ("file now or face jail"), and unverifiable superlatives.
